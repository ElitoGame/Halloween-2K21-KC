...
# Give out Masks:
# Gray
execute if predicate halloween:chances/5 run function halloween:trades/masks/give/1
execute if predicate halloween:chances/5 run function halloween:trades/masks/give/2
execute if predicate halloween:chances/5 run function halloween:trades/masks/give/3
# Yellow
